        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaltG = table.Column<decimal>(type: "numeric", nullable: false),
                    AllergensJson = table.Column<string>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodProducts_IngredientNutritions_NutritionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ingredients_IngredientNutritions_NutritionId",
                        column: x => x.NutritionId,
                        principalTable: "IngredientNutritions",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OCRExtractions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OCRExtractions_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookPage = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecipeSources_Recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "Recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodProducts_NutritionId",
                table: "FoodProducts",
                column: "NutritionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OCRExtractions_RecipeId",
                table: "OCRExtractions",
                column: "RecipeId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeSources_RecipeId",
                table: "RecipeSources",
                column: "RecipeId",
                unique: true);
